...
# top left
plot(Global_active_power ~ newdate, data=data_2007, type="l", ylab="Global Active Power", xlab="")

# top right
plot(Voltage ~ newdate, data=data_2007, type="l", ylab="Voltage")
...
## Add legend
legend("topright", col=c("black", "red", "blue"), legend=c("Sub_metering1", "Sub_metering_2", "Sub_metering_3"), lty=1, bty="n")

# bottom right
plot(Global_reactive_power ~ newdate, data=data_2007, type="l")
